    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.PositiveIntegerField(help_text="Defines the order in which permissions are applied for user's that are in multiple roles. With the lowest level role being applied last.")),
            ],
            options={
                'verbose_name': 'Role',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(default=0)),
                ('status', models.CharField(choices=[('ok', 'Ok'), ('pending', 'Pending'), ('deactivated', 'Deactivated'), ('failed', 'Failed'), ('expired', 'Expired')], default='ok', max_length=12)),
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='roles', to='account.organization')),
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='organization_roles', to='account.role')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(default=0)),
                ('status', models.CharField(choices=[('ok', 'Ok'), ('pending', 'Pending'), ('deactivated', 'Deactivated'), ('failed', 'Failed'), ('expired', 'Expired')], default='ok', max_length=12)),
                ('permissions', django_grainy.fields.PermissionField(help_text='Will grand this level of permissions to the specified role')),
                ('managed_permission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='role_auto_grants', to='account.managedpermission')),
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='managed_permissions', to='account.role')),
            ],
            options={
