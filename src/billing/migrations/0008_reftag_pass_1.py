...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='subscriptioncycleproduct',
            name='cycle',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cycleproduct_set', to='billing.subscriptioncycle'),
        ),
        migrations.AlterField(
            model_name='subscriptionproduct',
            name='sub',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subproduct_set', to='billing.subscription'),
        ),
    ]
