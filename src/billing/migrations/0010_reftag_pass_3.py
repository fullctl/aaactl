...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='price',
            field=models.DecimalField(decimal_places=2, default=0.0, help_text='Price attributed to subscription_cycle for this product', max_digits=6),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='price',
            field=models.DecimalField(decimal_places=2, default=0.0, help_text='Price in the context of recurring_product charges. For fixed recurring_product pricing this would be the price charged each subscription_cycle. For metered pricing this would be the usage price per metered unit.', max_digits=6),
        ),
        migrations.AlterField(
            model_name='subscription',
            name='group',
        ...
        migrations.AlterField(
            model_name='subscriptioncycleproduct',
            name='usage',
            field=models.PositiveIntegerField(default=0, help_text='Usage attributed to subscription_cycle for this product'),
        ),
        migrations.AlterField(
            model_name='subscriptionproduct',
            name='product',
