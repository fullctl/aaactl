...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_history_item_set', to='billing.orderhistory'),
        ),
        migrations.AlterField(
            model_name='orderhistoryitem',
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(blank=True, help_text='Start of billing subscription_cycle', null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='subscription',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscription_product_set', to='billing.subscription'),
        ),
    ]
